...
class RoundedRectangle : public Renderable
{
	...
	public:
	virtual ~RoundedRectangle() { SDL_LogDebug(SDL_LOG_CATEGORY_APPLICATION, "~RoundedRectangle %lx\n", (unsigned long)this); }
	RoundedRectangle(SDL_Color color, SDL_Rect dest, int radius, SDL_Color fillColor);
