...
function SystemUpdate:build()
	...
	self:addButton(
		btn,
		'Local',
		function() self:runTask('vimes.local', 'sudo apt update && sudo apt upgrade -y') end,
		textcolor,
		nil,
		backcolor
	)
	...
	self:addButton(
		btn,
		'Octavo',
		function() self:runTask('octavo.local', 'sudo dnf update -y') end,
		textcolor,
		nil,
		backcolor
	)
	...
	self:addButton(
		btn,
		'ModelB',
		function() self:runTask('modelb.local', 'sudo apt update && sudo apt upgrade -y') end,
		textcolor,
		nil,
		backcolor
	)
	...
	self:addButton(
		btn,
		'Vader',
		function() self:runTask('vader.local', 'sudo dnf update -y') end,
		textcolor,
		nil,
		backcolor
	)
...
function SystemUpdate:swipe(direction)
	...
	if direction == Swipe.Left and app.isPictureFrame == false then mainScreen:activate() end
