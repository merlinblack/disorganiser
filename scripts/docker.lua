...
function Docker:build()
	...
	self:addButton(btn, 'products', function() self:start 'products2' end, textcolor, nil, backcolor)
	btn[2] = btn[2] - 112
...
function Docker:durdur() self:runOnVader 'durdur' end
...
function Docker:runOnVader(prog)
	...
	function task()
		...
		local tl =
			TextLog(renderList, 11, 24, Color '4f0f', Color 'fff', font, app.width - 400, app.height - clockHeight - 24)
