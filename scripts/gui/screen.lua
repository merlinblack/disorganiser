...
function Screen:setStandardFont() self.font = Font('media/pirulen.otf', 22) end

function Screen:build() end
...
function Screen:deactivate() print('Deactivating Screen: ', self.__type) end
