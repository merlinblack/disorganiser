...
function InputGroup:enable(enabled) self.enabled = enabled end

function InputGroup:mouseMoved(time, x, y, button)
	if self.enabled then Widget.mouseMoved(self, time, x, y, button) end
end

function InputGroup:mouseClick(time, x, y, button)
	if self.enabled then Widget.mouseClick(self, time, x, y, button) end
end

function InputGroup:mouseDown(time, x, y, button)
	if self.enabled then Widget.mouseDown(self, time, x, y, button) end
end
